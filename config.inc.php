<?php
// note api
$oauth_base_url = 'https://note.youdao.com';
...
define('DB_MYSQL_HOST', $_ENV['MYSQL_HOST']);
define('DB_MYSQL_USERNAME', $_ENV['MYSQL_USERNAME']);
define('DB_MYSQL_PASSWORD', $_ENV['MYSQL_PASSWORD']);
define('DB_MYSQL_DBNAME', $_ENV['MYSQL_DBNAME']);
define('DB_MYSQL_PORT', $_ENV['MYSQL_PORT']);

// misc
define('SITE_URL', '//note2site.ixxoo.me');
